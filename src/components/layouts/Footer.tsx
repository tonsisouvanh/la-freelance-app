...
const Footer = ({ className }: Props) => {
  return (
    // <Footers
    //   className={`flex pb-[4rem] bg-white border flex-col justify-center items-center ${
    //     className && className
    //   }`}
    // >
        ...
        <div className="py-10 flex justify-between items-center flex-col gap-8 xl:flex-row">
          <div className="flex items-center flex-col xl:flex-row ">
            ...
            <ul className="text-lg  flex items-center flex-col md:flex-row  py-8 gap-6 md:gap-12 xl:border-l border-gray-200 xl:ml-11 xl:pl-11 transition-all duration-500">
              <li>
                <a href="#" className="text-gray-800 hover:text-color-1">
                  LA-Freelance
                </a>
              </li>
              <li>
          ...
          <div className="flex  space-x-4 sm:justify-center  ">
            <a
              href="#"
              className="group w-9 h-9 rounded-full border border-gray-300 flex justify-center items-center transition-all duration-500 hover:border-color-1"
            >
              <svg
                className="text-gray-700 transition-all duration-500  group-hover:text-color-1"
            ...
            >
              <svg
                className="w-[1.25rem] h-[1.125rem] text-gray-700 transition-all duration-500  group-hover:text-color-1"
                viewBox="0 0 15 15"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            >
              <svg
                className="w-[1rem] h-[1rem] text-gray-700 transition-all duration-500  group-hover:text-color-1"
                viewBox="0 0 13 12"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            >
              <svg
                className="w-[1.25rem] h-[0.875rem] text-gray-700 transition-all duration-500  group-hover:text-color-1"
                viewBox="0 0 16 12"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center">
            <span className="text-gray-400 ">
              LA-FREELANCE ©{new Date().getFullYear()} Created by LAF reserved.
            </span>
          </div>
        </div>
      </div>

...
const Hero = () => {
  return (
    ...
    <section className="relative bg-black py-24">
      ...
      <div className="relative gap-[52px] max-w-screen-xl mx-auto w-full mx-autod px-8 z-10 text-white flex flex-col items-center">
        <div className="text-center space-y-3">
          ...
          <h1 className="text-[36px]">
            ສູນລວມ
            <span className="relative font-robotocon inline-flex justify-center whitespace-nowrap font-bold">
              {/* <img
              src={horizalline}
            ...
            /> */}
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-2/3 left-0 h-[0.58em] w-full fill-color-1"
        ...
        <form action="" className="w-full max-w-[600px] ">
          <div className="border divide-x-2 gap-[12px] border-color-1 flex items-center bg-white rounded-full px-[12px] py-[14px]">
            <div className="flex w-full max-w-3xl items-center gap-[12px]">
              <IoSearchOutline size={30} className="text-color-1 font-medium" />
              <input
                type="text"
                className="bg-transparent w-full max-w-5xl focus:outline-none text-color-3"
                placeholder="Search freelancer or project name / category"
              />
            </div>
            <select className="text-color-3 focus:outline-none px-2">
              <option selected value="1">
                ຟີຣແລນສ໌
              </option>
              <option value="2">ຊື່ໂປຣເຈັກ</option>
            </select>
          </div>
        </form>
      </div>
